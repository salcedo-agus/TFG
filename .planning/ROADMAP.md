...
- [x] **Phase 3: Bridge & Correctness Fixes** - Fix `Rocket%rm_L` init, deduplicate the ctypes bridge, remove the hardcoded MinGW path (completed 2026-09-17)
...
**Plans**: 5/5 plans executed + 2 gap-closure plans (from UAT G-01-2, G-01-4)
...
- [x] 01-02-PLAN.md
- [x] 01-03-PLAN.md
- [x] 01-04-PLAN.md — Fix `Rocket%rm_L` init on the ctypes/GUI path (G-01-2, null masses)
- [x] 01-05-PLAN.md — Fix `test_call.py` import after interface/ reorg (G-01-4, ModuleNotFoundError)
...
- [x] 02-01: Add Fortran bind(C) pipeline entry to C_Interface (reuse pre-staging, staging, thrust, geometry)
...
| 3. Bridge & Correctness Fixes | 2/2 | Complete    | 2026-09-17 |
